...
и synonyms.csv при старте сервиса; обновление доменных файлов не требует
правки кода.
"""
import csv
...
# Промпты живут в доменном каталоге рядом с онтологией и словарями: каталог
# монтируется в контейнер, правка применяется перезапуском без пересборки
_TEMPLATE_NAMES = {
